...
pub const DEFAULT_CLIENT_DECISION_COOLDOWN_SECONDS: u32 = 300;
pub const MIN_CLIENT_ISOLATED_LEVERAGE: u8 = 1;
pub const MAX_CLIENT_ISOLATED_LEVERAGE: u8 = 10;
pub const DEFAULT_CLIENT_ISOLATED_LEVERAGE: u8 = 1;
