...
Crow Agent v0.1.24-alpha.29 is a free, testnet-only public alpha. Do not connect
it to live capital.

- [Release page and notes](https://github.com/crow-compute/crow-agent/releases/tag/harness-v0.1.24-alpha.29)
- [macOS universal DMG](https://github.com/crow-compute/crow-agent/releases/download/harness-v0.1.24-alpha.29/Crow.Agent_0.1.24_universal.dmg)
- [Windows x86-64 installer](https://github.com/crow-compute/crow-agent/releases/download/harness-v0.1.24-alpha.29/Crow.Agent_0.1.24_x64-setup.exe)
- [Ubuntu 22.04/24.04 x86-64 daemon](https://github.com/crow-compute/crow-agent/releases/download/harness-v0.1.24-alpha.29/crow-agent-linux-x86_64.tar.zst)
